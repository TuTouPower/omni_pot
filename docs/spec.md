...
| `text` | `getSelection` / `writeClipboard` / `writeClipboardImage` / `onTranslateFromSelection` / `onInputTranslate` / `onTranslateFromApi` / `onTranslateFromClipboard` / `onDictLookup` / `onTranslateSelectionEmpty` / `onDictSelectionEmpty` |
