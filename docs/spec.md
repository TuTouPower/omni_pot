...
Tabs 切换**五类服务**：翻译 / Chinese Dictionary / 英文词典 / 文字识别 / 语音朗读。页面整体布局、服务卡片、字段展示和交互必须按 `docs/design/omni-pot/` 设计稿对齐。
...
| `english_dictionary_service_list` | string[] | `['cambridge_dict@default']` | 英文词典实例顺序 |
