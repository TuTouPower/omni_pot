...
| 翻译 | `translate` | 自适应内容 | 430×320 | 失焦可关闭、可固定、可置顶、frameless；窗口高度贴合内容，长文本由内部滚动消化 |
...
- 翻译窗口高度自适应内容，长文本由源文本卡内部滚动消化，按钮永驻不被遮挡
...
- 系统托盘菜单中文化为 4 个功能项 + 设置 / 更新 / 日志 / 重启 / 退出，每个功能项右侧显示完整快捷键（`Ctrl + Alt + ...`）
- 截图窗口主色仅用于选区描边与尺寸标签
- 所有图标按钮大小接近汉字大小
