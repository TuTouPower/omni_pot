...
| **SimplyTranslate AI**       | 可试的公网翻译 API                   | 文档显示匿名使用无需 key，并提供 `/translate` 示例；但文档页面有明显 i18n 文案渲染问题，生产前要实测稳定性。([SimplyTranslate AI][5])                             |
...
[5]: https://simplytranslate.ai/api-docs/ "SimplyTranslate AI - Free AI Translation Tool | 196+ Languages Supported"
[6]: https://freedictionaryapi.com/ "Free Dictionary API"
[7]: https://dictionaryapi.dev/ "Free Dictionary API"
[8]: https://www.datamuse.com/api/ "Datamuse API"
[9]: https://www.mediawiki.org/wiki/API "API - MediaWiki"
[10]: https://www.mdbg.net/chinese/dictionary?page=cedict "MDBG Chinese Dictionary"
...
### 💡 总结建议：
*   如果你的项目需要**翻译句子**，直接用 **MyMemory API** 或自托管 **LibreTranslate**。
