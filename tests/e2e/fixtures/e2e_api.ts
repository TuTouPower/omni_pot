...
export class E2eApi {
    ...
    async trayAction(action: 'input_translate' | 'dictionary' | 'ocr_recognize' | 'screenshot_translate' | 'config' | 'auto_start' | 'clipboard_monitor' | 'survey' | 'support_author' | 'check_update' | 'view_log' | 'tray_click' | 'show_tray' | 'restart' | 'quit'): Promise<{ success: boolean; action?: string; error?: string }> {
