...
test.describe('@ui i18n', () => {
    test('user switches interface language and already-open windows update immediately', async () => {
        ...
        try {
            ...
            await expect_tray_labels(omni, ['输入翻译', 'OCR 识别', '截图翻译', '剪贴板监听', '设置', '重启', '退出'])
            ...
            await expect_tray_labels(omni, ['Input Translate', 'OCR Recognize', 'Screenshot Translate', 'Clipboard Monitor', 'Settings', 'Restart', 'Quit'])
