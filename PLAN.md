...
- [ ] **词典结果卡片同构**：每个词典服务渲染一张统一 DictResult 卡片，结构对齐翻译结果卡片（拖拽手柄 / 服务名 / 朗读 / 复制 / 收藏 / 折叠），发音、释义、例句都在同一张服务卡片 body 内。
- [ ] **词典发音行**：英文音标、中文拼音按服务结果展示；每个发音项带朗读按钮；Cambridge UK / US 合并到同一组内清晰展示。
- [ ] **用户可见术语统一为“词典”**：托盘、快捷键页、欢迎页、窗口标题、服务相关入口不再显示“字典词典”。
- [ ] **服务设置 Tab 文案**：服务页 tab 使用“文字识别 / 语音朗读”，不使用“识别 / 朗读”简称。
